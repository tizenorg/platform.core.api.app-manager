...
static int _convert_app_status_type(int app_status_type)
{
	...
	if ((app_status_type & APP_MANAGER_APP_EVENT_TYPE_ENABLE)
			== APP_MANAGER_APP_EVENT_TYPE_ENABLE)
		result += PKGMGR_CLIENT_STATUS_ENABLE_APP;

	if ((app_status_type & APP_MANAGER_APP_EVENT_TYPE_DISABLE)
			== APP_MANAGER_APP_EVENT_TYPE_DISABLE)
