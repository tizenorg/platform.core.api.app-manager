 ...
 */
typedef enum {
	APP_MANAGER_APP_EVENT_TYPE_ALL = 0x00,               /**< All status */
	APP_MANAGER_APP_EVENT_TYPE_ENABLE = 0x01,           /**< Application enable event*/
	APP_MANAGER_APP_EVENT_TYPE_DISABLE = 0x02,         /**< Application disable event */
} app_manager_app_status_type_e;


//TODO(jungh.yeon) : add description about this
typedef enum {
