 ...
 *		Since Tizen 3.0, the shared/data directory is supported only for the apps that declares http://tizen.org/privilege/appdir.shareddata privilege.
 *		When you try to get shared/data path for an app that doesn't declare the privilege, #APP_MANAGER_ERROR_NOT_SUPPORTED will be returned.
 *
 * @param[in]      app_id  The ID of the application
