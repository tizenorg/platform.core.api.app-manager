 ...
 * @param[in] application     The name of the app to be enabled or disabled
 ...
 * @param[in] user_data   The user data passed from app_manager_event_set_cb()
 * @pre  This function is called when an application being disabled or enabled, after you register this callback using app_manager_event_set_cb().
 *
 * @see app_manager_event_set_cb()
 * @see app_manager_event_unset_cb()
 */
...
/**
 * @brief Sets the event to handle to select app event to listen.
...
/**
 * @brief Registers a callback function to be invoked when the app is event has occured
 * @since_tizen 3.0
 * @param[in] handle    The app manager event handle
 ...
 * @see app_manager_event_unset_cb()
 */
int app_manager_event_set_cb(app_manager_event_h handle,
 ...
 * @see app_manager_event_set_cb()
 */
int app_manager_event_unset_cb(app_manager_event_h handle);

/**
 * @brief Destroys the app manager event handle.
 * @since_tizen 3.0
 *
 * @param[in] handle The app managerevent handle
 *
 * @return @c 0 on success,
 *         otherwise a negative error value
 *
