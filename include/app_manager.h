 ...
 */
typedef void (*app_manager_app_status_cb) (const char *application, app_event_type_e event_type, app_event_state_e event_state, int progress, void *user_data);
 ...
 * @see app_manager_set_app_status_cb()
 */
int app_manager_unset_app_status_cb(app_manager_event_h manager);
 ...
 * @retval  #APP_MANAGER_ERROR_PERMISSION_DENIED  Permission denied
 * @retval  #APP_MANAGER_ERROR_REQUEST_FAILED  Internal error
 * @see app_manager_unset_app_status_cb()
 * @see app_manager_app_status_type_e
 */
int app_manager_set_app_status_cb(app_manager_event_h *manager, app_manager_app_status_cb callback, int event_state, void *user_data);
